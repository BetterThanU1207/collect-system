var menuData = [
    {
        "id": "1", "iconCls": "fa fa-send-o", "text": "敏捷开发", "children": [
            { "id": "1_1", iconCls: "fa fa-desktop", text: "代码生成器", url: "page/dmscq.html" },
            { "id": "1_2", iconCls: "fa fa-search", text: "图标查看", url: "page/tbck.html" },
            { "id": "1_3", iconCls: "fa fa-send-o", text: "插件演示" },
            {
                "id": "1_4", iconCls: "fa fa-window-restore", text: "开发示例", children: [
                    { "id": "1_4_1", iconCls: "fa fa-assistive-listening-systems", text: "商机管理" },
                    { "id": "khgl", iconCls: "fa fa-vcard", text: "客户管理" },
                    { "id": "kpxx", iconCls: "fa fa-file-excel-o", text: "开票信息" },
                    { "id": "khdd", iconCls: "fa fa-modx", text: "客户订单" }
                ]
            }
        ]
    },
    {
        "id": "xtgl", iconCls: "fa fa-desktop", text: "系统管理", children: [
            { "id": "xzgl", iconCls: "fa fa-leaf", text: "行政管理", url: "/showtable.html" },
            { "id": "sjzd", iconCls: "fa fa-book", text: "数据字典" },
            { "id": "djbm", iconCls: "fa fa-barcode", text: "单据编码" },
